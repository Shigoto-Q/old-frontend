                    ...
                    <div className="container px-5 py-24 mx-auto">
                        <div
                            ...
                            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Monitoring</h2>
                                <p className="leading-relaxed text-base">
                                    Superb and fast monitoring, see in real time if something breaks or succeeds.
                                </p>
                        ...
                        <div
                            className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
                            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Planning</h2>
                                <p className="leading-relaxed text-base">
                                    We have provided tools so you can easily create a schedule.
                                </p>
                                <a className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                         stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2"
                        ...
                        <div className="flex items-center lg:w-3/5 mx-auto sm:flex-row flex-col">
                            ...
                            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                                <h2 className="text-gray-900 text-lg title-font font-medium mb-2">Scalability</h2>
                                <p className="leading-relaxed text-base">
                                    With the choice of deploying on Kubernetes, you never have to worry about the scalability for your project.
                                </p>
                                <a className="mt-3 text-indigo-500 inline-flex items-center">Learn More
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                         stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2"
